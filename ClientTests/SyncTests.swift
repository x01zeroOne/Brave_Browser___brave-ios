...
class SyncTests: XCTestCase {
  ...
  func testOldSyncVersion() throws {
    let result = BraveSyncQRCodeModel(
      ...
      notValidAfter: validDate
    ).validate(syncAPI: syncAPI)
  ...
  func testInvalidSyncCode() throws {
    // Test code too short
    var result = BraveSyncQRCodeModel(
      version: BraveSyncQRCodeModel.currentlySupportedVersion,
