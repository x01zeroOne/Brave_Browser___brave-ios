...
class PlaylistTests: XCTestCase {
  func testVideoPlayerTrackBarTimeFormatter() throws {
    ...
    XCTAssert(
      VideoTrackerBar
        .timeToString(CMTimeMakeWithSeconds(60 * 60, preferredTimescale: 1)) == "01:00:00"
    ) // hh:mm:ss
    XCTAssert(
      VideoTrackerBar
        .timeToString(CMTimeMakeWithSeconds(60 * 60 * 24, preferredTimescale: 1)) == "1d 00:00:00"
    ) // dd hh:mm:ss
  }
  ...
  func testVideoPlayerTrackBarTimeManualFormatter() throws {
    ...
    XCTAssert(
      VideoTrackerBar
        .timeToString(CMTimeMakeWithSeconds(60 * 60 * 24, preferredTimescale: 1)) == "01:00:00:00"
    ) // dd:hh:mm:ss
  }
