...
private struct _WalletHostingController: UIViewControllerRepresentable {
  func makeUIViewController(context: Context) -> some UIViewController {
    guard
      ...
      let rpcService = BraveWallet.EthJsonrpcServiceFactory.get(privateMode: false),
      let assetRatioService = BraveWallet.assetRatioServiceFactory.get(privateMode: false),
    ...
    let walletStore = WalletStore(
      ...
      transactionService: txController
    )
