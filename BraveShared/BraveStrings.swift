...
extension Strings {
  ...
  public static var BAT: String {
    Preferences.Rewards.isUsingBAP.value == true ? "BAP" : "BAT"
  }
}
...
extension Strings {
  ...
  public static let monthAbbreviation =
    NSLocalizedString(
      ...
      bundle: .braveShared, value: "mo.",
      comment: "Abbreviation for 'Month', use full word' Month' if this word can't be shortened in your language"
    )
  public static let yearAbbreviation =
    NSLocalizedString(
      "yearAbbreviation", tableName: "BraveShared",
      bundle: .braveShared, value: "yr.",
      comment: "Abbreviation for 'Year', use full word' Yeara' if this word can't be shortened in your language"
    )
}
...
extension Strings {
  ...
  public static let clearSyncedHistoryAlertMessage = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "This action will clear all of your private data, including history from your synced devices.",
...
extension Strings {
  ...
  public static let searchSuggestionSectionTitleFormat = NSLocalizedString(
    ...
    bundle: Bundle.braveShared,
    value: "%@ Search",
    comment: "Section Title when showing search suggestions. The parameter substituted for \"%@\" is the name of the search engine. E.g.: Google Search"
  )
  ...
  public static let searchSuggestionSectionTitleNoSearchFormat = NSLocalizedString(
    ...
    bundle: Bundle.braveShared,
    value: "Search",
    comment: "Section Title when showing search suggestions and the engine does not contain the word 'Search'."
  )
...
extension Strings {
  ...
  public static let bookmarkAllTabsTitle = NSLocalizedString(
    ...
    comment: "Action item title of long press for Adding Bookmark for All Tabs in Tab List"
  )
...
extension Strings {
  ...
  public static let loginDetailLastModifiedCellFormatTitle = NSLocalizedString(
    ...
    bundle: Bundle.braveShared,
    value: "Last modified %@",
    comment: "Footer label describing when the current login was last modified with the timestamp as the parameter."
  )
}
...
extension Strings {
  public static let readerModeLoadingContentDisplayText = NSLocalizedString(
    ...
    comment: "Message displayed when the reader mode page is loading. This message will appear only when sharing to Brave reader mode from another app."
  )
  public static let readerModePageCantShowDisplayText = NSLocalizedString(
    ...
    comment: "Message displayed when the reader mode page could not be loaded. This message will appear only when sharing to Brave reader mode from another app."
  )
  public static let readerModeLoadOriginalLinkText = NSLocalizedString(
    ...
    comment: "Link for going to the non-reader page when the reader view could not be loaded. This message will appear only when sharing to Brave reader mode from another app."
  )
...
extension Strings {
  ...
  public static let authenticationLoginsTouchReason = NSLocalizedString(
    ...
    comment: "Touch ID or PIN entry prompt subtitle when accessing Brave with the Browser Lock feature enabled"
  )

  public static let browserLockMigrationTitle = NSLocalizedString(
    "browserLockMigrationTitle",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Open Brave with your Apple Face ID, Touch ID, or passcode",
  ...
  public static let browserLockMigrationSubtitle = NSLocalizedString(
    "browserLockMigrationSubtitle",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "We’ve simplified Brave Passcodes. You can now access Brave with the same ID or passcode you use on your phone.",
    comment: "Subtitle on the screen shown to the user when they are being migrated from the old Passcode feature to the new Browser Lock feature"
  )

  public static let browserLockMigrationNoPasscodeSetup = NSLocalizedString(
    "browserLockMigrationNoPasscodeSetup",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Haven't set an ID or passcode? Open Settings, then tap \"%@\"",
    comment: "Displayed to the user when they don't have a passcode set on their phone, therefore cannot use the Browser Lock feature. \"%@\" will be filled with either \"Touch ID & Passcode\" or \"Face ID & Passcode\""
  )

  public static let browserLockMigrationContinueButtonTitle = NSLocalizedString(
    "browserLockMigrationContinueButtonTitle",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Continue",
    comment: "A button title for the action to move to the next step of the browser lock migration process."
  )
}
...
extension Strings {
  ...
  public static let enablePullToRefresh =
    NSLocalizedString(
      ...
      bundle: .braveShared, value: "Enable Pull-to-refresh",
      comment: "Describes whether or not the feature that allows the user to pull down from the top of a web page a certain amount before it triggers a page refresh"
    )
}
...
extension Strings {
  ...
  public static let errorPagesAdvancedWarningTitle = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Attackers might be trying to steal your information from %@ (for example, passwords, messages, or credit cards).",
  ...
  public static let errorPagesAdvancedWarningDetails = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "This server could not prove that it is %@; its security certificate is not trusted by your device's operating system. This may be caused by a misconfiguration or an attacker trying to intercept your connection.",
...
extension Strings {
  ...
  public static let syncSettingsHeader = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "The device list below includes all devices in your sync chain. Each device can be managed from any other device.",
  ...
  public static let braveSyncWelcome = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "To start, you will need Brave installed on all the devices you plan to sync. To chain them together, start a sync chain that you will use to securely link all of your devices together.",
  ...
  public static let syncToDeviceDescription = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Using existing synced device open Brave Settings and navigate to Settings -> Sync. Choose \"Add Device\" and scan the code displayed on the screen.",
  ...
  public static let syncAddDeviceScanDescription = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "On your second mobile device, navigate to Sync in the Settings panel and tap the button \"Scan Sync Code\". Use your camera to scan the QR Code below.\n\n Treat this code like a password. If someone gets hold of it, they can read and modify your synced data.",
  ...
  public static let syncAddDeviceWordsDescription = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "On your device, navigate to Sync in the Settings panel and tap the button \"%@\". Enter the sync chain code words shown below.\n\n Treat this code like a password. If someone gets hold of it, they can read and modify your synced data.",
    comment: "Sync add device description"
  )
  ...
  public static let syncRemoveThisDeviceQuestionDesc = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "This device will be disconnected from sync group and no longer receive or send sync data. All existing data will remain on device.",
    comment: "Sync remove device?"
  )
  ...
  public static let syncRemoveLastDeviceMessage = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Data currently synced will be retained but all data in Brave’s Sync cache will be deleted. You will need to start a new sync chain to sync device data again.",
  ...
  public static let syncRemoveCurrentDeviceMessage = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Local device data will remain intact on all devices. Other devices in this Sync Chain will remain synced. ",
  ...
  public static let syncRemoveOtherDeviceMessage = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Removing the device from the Sync Chain will not clear previously synced data from the device.",
  ...
  public static let syncJoinChainCodewordsWarning = NSLocalizedString(
  ...
  public static let syncJoinChainCameraWarning = NSLocalizedString(
  ...
  public static let syncJoinChainWarningTitle = NSLocalizedString(
    "syncJoinChainWarningTitle",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Warning",
    comment: "Title for pairing sync device"
  )
  public static let syncNewerVersionError = NSLocalizedString(
    "syncNewerVersionError",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "This sync code was generated by a newer version of Brave on another device. Please update Brave on all synced devices and try again.",
    comment: "Sync Error Description"
  )
  public static let syncInsecureVersionError = NSLocalizedString(
    "syncInsecureVersionError",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "This sync code was generated by an outdated version of Brave on another device. Please update Brave on all synced devices and try again.",
    comment: "Sync Error Description"
  )
  public static let syncInvalidVersionError = NSLocalizedString(
    "syncInvalidVersionError",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
  ...
  public static let syncFutureVersionError = NSLocalizedString(
    "syncFutureVersionError",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Too New",
    comment: "Sync Error Description"
...
extension Strings {
  ...
  public static let browserLock = NSLocalizedString(
    "BrowserLock",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Browser Lock",
    comment: "Setting to enable the browser lock privacy feature"
  )
  public static let browserLockDescription = NSLocalizedString(
  ...
  public static let showBookmarkButtonInTopToolbar = NSLocalizedString(
    ...
    comment: "Setting to show a bookmark button on the top level menu that triggers a panel of the user's bookmarks."
  )
  ...
  public static let yes = NSLocalizedString(
    "Yes",
    bundle: Bundle.braveShared,
    comment: "For search suggestions prompt. This string should be short so it fits nicely on the prompt row."
  )
  ...
  public static let searchWithBrave = NSLocalizedString(
    ...
    comment: "Title of an action that allows user to perform a one-click web search for selected text"
  )
  ...
  public static let viewOn = NSLocalizedString(
    ...
    bundle: Bundle.braveShared,
    value: "View on %@",
    comment: "Label that says where to view an item. '%@' is a placeholder and will include things like 'Instagram', 'unsplash'. The full label will look like 'View  on Instagram'."
  )
  public static let photoBy = NSLocalizedString(
    ...
    bundle: Bundle.braveShared,
    value: "Photo by %@",
    comment: "Label that says who took a photograph that will be displayed to the user. '%@' is a placeholder and will include be a specific person's name, example 'Bill Gates'."
  )
...
extension Strings {
  ...
  public static let shieldsDefaultsFooter = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "These are the default Shields settings for new sites. Changing these won't affect your existing per-site settings.",
  ...
  public static let googleSafeBrowsingUsingWebKitDescription = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Sends obfuscated URLs of some pages you visit to the Google Safe Browsing service, when your security is at risk.",
    comment: ""
  )
  ...
  public static let showInLandscapeOnly = NSLocalizedString(
    ...
    comment: "Setting preference to only show the browser tabs bar when the device is in the landscape orientation."
  )
  ...
  public static let privateTabBody = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Private Tabs aren’t saved in Brave, but they don’t make you anonymous online. Sites you visit in a private tab won’t show up in your history and their cookies always vanish when you close them — there won’t be any trace of them left in Brave. However, downloads will be saved.\nYour mobile carrier (or the owner of the Wi-Fi network or VPN you’re connected to) can see which sites you visit and those sites will learn your public IP address, even in Private Tabs.",
  ...
  public static let privateBrowsingOnlyWarning = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Private Browsing Only mode will close all your current tabs and log you out of all sites.",
    comment: "When 'Private Browsing Only' is enabled, we need to alert the user of their normal tabs being destroyed"
  )
  ...
  public static let shieldsOverview = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Site Shields allow you to control when ads and trackers are blocked for each site that you visit. If you prefer to see ads on a specific site, you can enable them here.",
  ...
  public static let shieldsOverviewFooter = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Note: Some sites may require scripts to work properly so this shield is turned off by default.",
  ...
  public static let useRegionalAdblock = NSLocalizedString(
    ...
    comment: "Setting to allow user in non-english locale to use adblock rules specifc to their language"
  )
  ...
  public static let favoritesLocationFooterText = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Favorites are located on your home screen. These bookmarks are not synchronized with other devices.",
  ...
  public static let downloadsPanelEmptyStateTitle = NSLocalizedString(
    ...
    comment: "Title for when a user has nothing downloaded onto their device, and the list is empty."
  )
  public static let playlistMenuItem = NSLocalizedString(
    "PlaylistMenuItem",
    tableName: "BraveShared",
    bundle: Bundle.braveShared,
    value: "Playlist",
    comment: "Playlist menu item"
  )
  ...
  public static let themesDisplayBrightness = NSLocalizedString(
    ...
    bundle: Bundle.braveShared,
    value: "Appearance",
    comment: "Setting to choose the user interface theme for normal browsing mode, contains choices like 'light' or 'dark' themes"
  )
  public static let themesDisplayBrightnessFooter = NSLocalizedString(
    ...
    comment: "Text specifying that the above setting does not impact the user interface while they user is in private browsing mode."
  )
...
extension Strings {
  ...
  public static let OBShieldsDetail = NSLocalizedString(
    "OBShieldsDetail",
    bundle: Bundle.braveShared,
    value: "Block privacy-invading trackers so you can browse without being followed around the web",
  ...
  public static let OBRewardsDetail = NSLocalizedString(
    "OBRewardsDetail",
    bundle: Bundle.braveShared,
    value: "Opting into Brave Private Ads supports publishers and content creators with every ad viewed.",
    comment: "Detail text for rewards onboarding screen"
  )
  ...
  public static let OBPrivacyConsentDetail = NSLocalizedString(
    ...
    bundle: .braveShared,
    value: "You may have downloaded Brave in support of your referrer. To detect your referrer, Brave performs a one-time check of your clipboard for the matching referral code. This check is limited to the code only and no other personal data will be transmitted.  If you opt out, your referrer won’t receive rewards from Brave.",
    comment: ""
  )
...
extension Strings {
  public static let monthlyAdsClaimNotificationTitle = NSLocalizedString(
    ...
    bundle: Bundle.braveShared,
    value: "Brave Rewards 💵🎁",
    comment: "The title of the notification that goes out monthly to users who can claim an ads grant"
  )
  public static let monthlyAdsClaimNotificationBody = NSLocalizedString(
    ...
    comment: "The body of the notification that goes out monthly to users who can claim an ads grant"
  )
}
...
extension Strings {
  public struct NTP {
    ...
    public static let settingsDefaultImagesOnly = NSLocalizedString(
      ...
      comment: "A selection to let the users only see a set of predefined, default images on the background of the app."
    )
    public static let settingsSponsoredImagesSelection = NSLocalizedString(
      ...
      comment: "A selection to let the users see sponsored image backgrounds when opening a new tab."
    )
    public static let settingsAutoOpenKeyboard = NSLocalizedString(
      ...
      comment: "A setting to enable or disable the device's keyboard from opening automatically when creating a new tab."
    )
...
extension Strings {
  public struct Shields {
    ...
    public static let blockedInfoButtonAccessibilityLabel = NSLocalizedString(
      ...
      bundle: Bundle.braveShared,
      value: "Learn more",
      comment: "What the screen reader will read out when the user has VoiceOver on and taps on the question-mark info button on the shields panel"
    )
    ...
    public static let aboutBraveShieldsBody = NSLocalizedString(
      ...
      bundle: Bundle.braveShared,
      value: "Sites often include cookies and scripts which try to identify you and your device. They want to work out who you are and follow you across the web — tracking what you do on every site.\n\nBrave blocks these things so that you can browse without being followed around.",
    ...
    public static let shieldsDownDisclaimer = NSLocalizedString(
      ...
      bundle: Bundle.braveShared,
      value: "You're browsing this site without Brave's privacy protections. Does it not work right with Shields up?",
      comment: ""
    )
    ...
    public static let reportBrokenSiteBody1 = NSLocalizedString(
      ...
      comment: "First part of the report a broken site copy. After the colon is a new line and then a website address"
    )
    public static let reportBrokenSiteBody2 = NSLocalizedString(
      "ReportBrokenSiteBody2",
      bundle: Bundle.braveShared,
      value: "Note: This site address will be submitted with your Brave version number and your IP address (which will not be stored).",
      comment: ""
    )
    ...
    public static let siteReportedBody = NSLocalizedString(
      "SiteReportedBody",
      bundle: Bundle.braveShared,
      value: "Thanks for letting Brave's developers know that there's something wrong with this site. We'll do our best to fix it!",
      comment: ""
    )
  }
}
...
extension Strings {
  public struct RewardsInternals {
    ...
    public static let sharingWarningMessage = NSLocalizedString(
      ...
      bundle: Bundle.braveShared,
      value: "Data on this page may be sensitive. Treat them as you would your wallet private keys. Be careful who you share them with.",
      comment: ""
    )
  }
}
...
extension Strings {
  ...
  public static let recentSearchSectionDescription = NSLocalizedString(
    ...
    bundle: .braveShared,
    value: "Recent Searches allow you to privately access past searches. Would you like to enable Recent Searches?",
